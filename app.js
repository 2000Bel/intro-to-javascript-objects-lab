...
const pokemon1 = pokemon.find(pokemon => pokemon.name === "Pikachu");
const pokemon2 = pokemon.find(pokemon => pokemon.name === "Charmander");
const pokemon3 = pokemon.find(pokemon => pokemon.name === "Bulbasaur");
